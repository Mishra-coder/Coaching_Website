    ...
    <section id="home" className="hero">
      <div className="container hero-container">
        <div className="hero-content fade-in-up">
          ...
          <p>
            Premier offline coaching for{' '}
            <span className="highlight">Class 1st to 12th</span>. Experience the
            power of in-person learning with expert mentorship under{' '}
            <span className="highlight">Mr. Vikas Sir</span> &{' '}
            <span className="highlight">Mr. Himanshu Sir</span>.
          </p>
