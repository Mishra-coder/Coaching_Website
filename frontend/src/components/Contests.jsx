                    ...
                    <>
                        ...
                        <div className="row g-4">
                            {contests.map((contest) => {
                                const { isActive, isUpcoming, start, end } = getContestStatus(contest);
                                        ...
                                        <div className="enrollment-card contest-card">
                                            ...
                                            <div className="contest-details">
                                                <div className="contest-detail-item">
                                                    ...
                                                    <span><strong>Start:</strong> {formatDateTime(start)}</span>
                                                </div>
                                                <div className="contest-detail-item">
                                                    <i className="fas fa-stop-circle"></i>
                                                    <span><strong>End:</strong> {formatDateTime(end)}</span>
                                                </div>
                                                <div className="contest-detail-item">
                                            ...
                                            {isActive ? (
                                                <Link to={`/contest/${contest._id}`} className="btn-primary mt-3 contest-action-btn">
                                                    Start Contest
                                                </Link>
                                            ) : isUpcoming ? (
                                                <button className="btn-secondary mt-3 contest-action-btn" disabled>
                                                    Starts Soon
                                                </button>
                                            ) : (
                                                <Link to={`/contest/${contest._id}/result`} className="btn-secondary mt-3 contest-action-btn">
                                                    View Leaderboard
                                                </Link>
                                            )}
                                        </div>
