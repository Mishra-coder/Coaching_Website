...
const DemoBookingManager = () => {
    ...
    return (
        <div className="admin-container">
            ...
            <div className="admin-manager-layout" style={{ gridTemplateColumns: selectedBooking ? '1fr 1.2fr' : '1fr' }}>
                <div className="admin-card">
                    <h4 style={{ marginBottom: '20px' }}>All Demo Bookings</h4>
                    
                    {filteredBookings.length === 0 ? (
                        <div style={{ textAlign: 'center', padding: '60px 20px', color: '#64748b' }}>
                            <i className="fas fa-calendar-times" style={{ fontSize: '3rem', marginBottom: '20px', opacity: 0.3 }}></i>
                            <p style={{ fontSize: '1.1rem', fontWeight: '500', marginBottom: '10px' }}>No demo bookings found</p>
                        ...
                        {filteredBookings.map((booking) => (
                            <div key={booking._id} className="enrollment-card-mobile">
                                <div className="enrollment-card-header">
                                    <div>
                                        <div className="enrollment-student-name">{booking.name}</div>
                                        <div className="enrollment-date">{formatDate(booking.createdAt)}</div>
                                    </div>
                ...
                {selectedBooking && (
                    <div ref={detailsPanelRef} className="admin-card fade-in enrollment-details-panel">
                        <div className="details-panel-header">
                            <h3 style={{ margin: 0, color: '#1a237e' }}>Demo Booking Details</h3>
                        ...
                        <div className="enrollment-details-top">
                            <div className="student-photo-preview-large" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f8fafc' }}>
                                <i className="fas fa-calendar-check" style={{ fontSize: '3rem', color: '#667eea' }}></i>
                            </div>
                            ...
                            <div style={{ flex: 1 }}>
                                <div style={{ marginBottom: '15px' }}>
                                    ...
                                    <select
                                        ...
                                        onChange={(e) => handleStatusUpdate(selectedBooking._id, e.target.value, selectedBooking.adminRemarks)}
                                ...
                                <div>
                                    ...
                                    />
                                    <button
                                        onClick={() => handleStatusUpdate(selectedBooking._id, selectedBooking.status, selectedBooking.adminRemarks)}
                        ...
                        <div className="details-grid">
                            ...
                            <div>
                                ...
                                <p className="info-value">{selectedBooking.user?.email || 'N/A'}</p>
                            </div>
                            <div>
                                <label className="detail-label">Phone Number</label>
                                <p className="info-value">
                                    <a href={`tel:${selectedBooking.phone}`} style={{ color: '#667eea', textDecoration: 'none' }}>
                            ...
                            <div>
                                ...
                                <p className="info-value">{formatDate(selectedBooking.preferredDate)}</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p className="info-value">{formatDate(selectedBooking.createdAt)}</p>
                            </div>
                            <div>
