...
const StudentManager = () => {
    ...
    if (loading) return <div className="admin-container">Loading students...</div>;

    return (
        <div className="admin-container">
            <h2 className="admin-header-title">Student Manager</h2>

            <div className="admin-manager-layout" style={{ gridTemplateColumns: selectedStudent ? '1fr 1fr' : '1fr' }}>
                ...
                {selectedStudent && (
                    <div className="admin-card fade-in">
                        <div className="details-panel-header">
                            ...
                            <button onClick={() => setSelectedStudent(null)} className="close-btn">Close</button>
                        </div>
                        <div style={{ display: 'grid', gap: '15px' }}>
                            {performance.map((p, i) => (
                                <div key={i} className="info-display-card" style={{ display: 'flex', justifyContent: 'space-between' }}>
                                    <div>
