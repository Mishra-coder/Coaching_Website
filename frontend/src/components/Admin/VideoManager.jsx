...
const VideoManager = () => {
    ...
    const [confirmDialog, setConfirmDialog] = useState({ isOpen: false, videoId: null });
    ...
    const handleUpload = async (e) => {
        ...
        try {
            ...
            setToast({ message: 'Video uploaded successfully! Processing started.', type: 'success' });
            ...
            <div className="admin-manager-layout">
                <div className="manager-section">
                    ...
                    <form onSubmit={handleUpload} className="upload-form">
                        ...
                        <div className="form-group">
                            <label className="form-label">Video File (MP4, AVI, MOV, MKV)</label>
                            <input
                                type="file"
                                accept="video/*"
