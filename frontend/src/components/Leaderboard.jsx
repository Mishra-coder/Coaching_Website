        ...
        <div className="leaderboard-page">
            <div className="leaderboard-header">
                <div className="header-controls">
                    ...
                    <button className="info-button" onClick={() => setShowModal(true)}>How it Works</button>
                </div>
            ...
            <div className="leaderboard-content">
                <div className="action-banner">
                    ...
                    <div className="banner-actions">
                        <button className="btn-primary" onClick={() => navigate('/quiz')}>Solve Quizzes</button>
                    </div>
                </div>
                ...
                <div className="modal-backdrop" onClick={() => setShowModal(false)}>
                    <div className="info-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="info-section">
                            ...
                            <p className="section-description">Earn more XP to climb on top of the leaderboard</p>
                        </div>

                        <div className="info-section">
                            <div className="section-icon">⚡</div>
                            <h3 className="section-title">What is XP</h3>
                            <p className="section-description">A currency to measure your efforts and skills</p>
                        </div>

                        <div className="info-section">
                            <div className="section-icon">⚡</div>
                            <h3 className="section-title">How to Earn XP</h3>
                            <p className="section-description">Earn XP from attending lectures and solving problems</p>
                        </div>

                        <div className="info-section">
                            <div className="section-icon">2×</div>
                            <h3 className="section-title">When is the 2X Multiplier applied</h3>
                            <p className="section-description">Win 2x XP for solving questions before the deadline</p>
                        </div>
