...
const ContestResult = () => {
  ...
  const myRank =
    leaderboard.findIndex((entry) => entry.userId.toString() === user.id) + 1;
            ...
            <div className="result-answers">
              ...
              {result.answers.map((answer, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`result-answer-card ${answer.isCorrect ? 'correct' : 'incorrect'}`}
                  >
                    <div className="result-answer-header">
                      ...
                      <span
                        className={`result-answer-badge ${answer.isCorrect ? 'correct' : 'incorrect'}`}
                      >
                        {answer.isCorrect ? (
                          <>
                  ...
                  >
                    ...
                    <div className="leaderboard-user">
                      ...
                      <div className="leaderboard-user-info">
                        ...
                        <div className="leaderboard-user-email">
                          {entry.userEmail}
                        </div>
                      </div>
                    </div>
