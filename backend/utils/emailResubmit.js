        ...
        <div class="container">
            <div class="header">
                <div class="logo-title">
                    <img src="${process.env.FRONTEND_URL || 'https://success-mantra-dm.vercel.app'}/logo.png" alt="Success Mantra Institute" style="width: 60px; height: auto; display: block; border: 0;" />
